 ...
 */
import generateCSSUnit from "./uagb-controls/generateCSSUnit"
...
function inlineStyles( props, isEditor ) {
	...
	if ( "image" === backgroundType ) {
		...
		// style["background-image"] = `url('https://i.pinimg.com/originals/a6/77/fb/a677fb9bb210d6bd3fc392237310aaaa.jpg')`
	...
	// 	style["opacity"] = backgroundOpacity?backgroundOpacity:null
	// }
